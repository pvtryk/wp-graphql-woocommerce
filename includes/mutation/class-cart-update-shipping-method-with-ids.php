<?php
/**
 * Mutation - updateShippingMethodWithIds
 *
...
/**
 * Class - Cart_Update_Shipping_Method_With_Ids
 */
class Cart_Update_Shipping_Method_With_Ids {
	...
	public static function get_input_fields() {
		return [
			'shippingMethods' => [
				'type' => [ 'list_of' => 'CartShippingMethodInput' ],
			],
		];
	}
	...
	public static function mutate_and_get_payload() {
		return function( $input ) {
			...
			$chosen_shipping_methods = Cart_Mutation::prepare_shipping_methods_based_on_ids( $input['shippingMethods'] );
